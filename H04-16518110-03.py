...
# dproduksi = data pegawai dproduksi
# gu = koefisien korelasi gaji dan usia (untuk perhitungan menentukan paling berkorelasi dengan yang mana)
# gg = koefisien korelasi gaji dan golongan (untuk perhitungan menentukan paling berkorelasi dengan yang mana)
# gt = koefisien korelasi gaji dan tahun masuk (untuk perhitungan menentukan paling berkorelasi dengan yang mana)
